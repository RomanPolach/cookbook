package cz.ackee.skeleton.screens.base.activity
...
import cz.ackee.skeleton.screens.layout.FragmentContainerLayout
import cz.ackee.skeleton.screens.layout.ToolbarLayout
...
open class FragmentActivity : AppCompatActivity() {
    ...
    /**
     * Extension with common logic for all activities
     */
    private val commonActivityLogicExtension = CommonActivityLogicExtension(this)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycle.addObserver(commonActivityLogicExtension)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        commonActivityLogicExtension.optionsItemSelected(item)
